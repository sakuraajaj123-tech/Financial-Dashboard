...
// and pre-filled WhatsApp payment reminders.
...
export function MakkahRentals({ isExternalModalOpen = false, onCloseExternalModal }) {
  ...
  return (
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      {/* ─── Middle Section: Tenant Ledger Table ────────────────────────────── */}
        ...
        <div className="p-5 border-b border-slate-700/50 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <h3 className="text-base sm:text-lg font-bold text-white tracking-wide flex items-center gap-2">
              ...
              {t('makkah.table.title')}
            </h3>
            <p className="text-xs text-slate-400 mt-0.5">
              {t('makkah.table.subtitle')}
            </p>
          </div>
                    ...
                    >
                      ...
                      <td className="px-5 py-3.5 whitespace-nowrap text-center">
                        <div className="flex items-center justify-center gap-1.5">
                          {/* 1. Mark as Paid (1-Click Update to Today) */}
                          <button
                            type="button"
                            onClick={() => handleMarkAsPaid(tenant.id, tenant.name)}
                          ...
                          {/* 2. WhatsApp Reminder Button (Prominent for overdue) */}
                          <button
                            type="button"
